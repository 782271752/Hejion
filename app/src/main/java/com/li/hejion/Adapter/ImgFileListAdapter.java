...
public class ImgFileListAdapter extends BaseAdapter{
	...
	public ImgFileListAdapter(Context context,List<HashMap<String, String>> listdata,int type) {
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg0 != index && arg0 > index) {
			holder=new Holder();
			arg1=LayoutInflater.from(context).inflate(R.layout.image_file_item, null);
		...
		if (bitmaps[arg0] == null) {
            ...
            if (type==0){
                imgSelectUtil.imgExcute(holder.photo_imgview,new ImgCallBack() {
                    @Override
                ...
                Log.e("imgpate",listdata.get(arg0).get(imgpath));
                holder.photo_imgview.setImageBitmap(VideoSelectUtil.getVideoThumbnail(listdata.get(arg0).get(imgpath),120,120, MediaStore.Video.Thumbnails.MICRO_KIND));
            }
