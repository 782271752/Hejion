...
public class ServerHelper {
    ...
    public final static String MESSAGE="massage";
    public final static String DATASTR="datastr";
...
//                message=message.substring(10,message.length()-1);
        ...
        if (!message.equals("")){
            try {
                ...
                response.setMassage(object.getString(MESSAGE));
                response.setDatastr(object.getString(DATASTR));
